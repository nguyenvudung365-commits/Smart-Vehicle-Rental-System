// FR-09: Màn hình danh sách chuyến đi
...
export default function TripsScreen() {
  ...
  // Set bookingId đã có review (để ẩn nút đánh giá)
                    ...
                    onPress={() => {
                      ...
                      router.push({
                        ...
                        params: {
                          ...
                          vehicleImage: item.vehicle?.images?.[0]?.imageUrl || '',
                        },
                      });
                    }}
                  >
...
const styles = StyleSheet.create({
  ...
  reviewedText: { color: COLORS.success, fontSize: FONT_SIZE.sm },
